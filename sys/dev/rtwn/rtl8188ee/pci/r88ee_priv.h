...
static const struct rtwn_bb_prog rtl8188eee_bb[] = {
	{
		nitems(rtl8188eee_bb_regs0),
		rtl8188eee_bb_regs0,
		rtl8188eee_bb_vals0_2t,
		{ R92C_COND_RTL8192C },
	...
	},
	{
		...
		&(const struct rtwn_bb_prog){
			nitems(rtl8188ee_bb_regs3),
			rtl8188ee_bb_regs3,
			rtl8188ee_bb_vals3_88cu_88ru,
			{ 0 },
			NULL
		}
	},
	{
		nitems(rtl8188ee_bb_regs4),
		rtl8188ee_bb_regs4,
		rtl8188ee_bb_vals4,
		{ 0 },
		NULL
