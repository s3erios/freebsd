...
static int
r88ee_tx_get_sco(struct rtwn_softc *sc, struct ieee80211_channel *c)
{
#if 0
...
static void
r88ee_tx_set_ht40(struct rtwn_softc *sc, void *buf, struct ieee80211_node *ni)
{
#if 0
...
static void
r88ee_tx_protection(struct rtwn_softc *sc, struct r88ee_tx_desc *txd,
...
static void
r88ee_tx_raid(struct rtwn_softc *sc, struct r88ee_tx_desc *txd,
...
static void
r88ee_tx_set_sgi(struct rtwn_softc *sc, void *buf, struct ieee80211_node *ni)
{
#if 0
	struct r88ee_tx_desc *txd = (struct r88ee_tx_desc *)buf;
	struct ieee80211vap *vap = ni->ni_vap;
...
void
r88ee_tx_enable_ampdu(void *buf, int enable)
{
#if 0
	struct r88ee_tx_desc *txd = (struct r88ee_tx_desc *)buf;
...
void
r88ee_tx_setup_macid(void *buf, int id)
{
#if 0
	struct r88ee_tx_desc *txd = (struct r88ee_tx_desc *)buf;
...
void
r88ee_fill_tx_desc(struct rtwn_softc *sc, struct ieee80211_node *ni,
    struct mbuf *m, void *buf, uint8_t ridx, int maxretry)
{
	...
	if (!ismcast) {
		...
		if (type == IEEE80211_FC0_TYPE_DATA) {
			...
			if (ridx >= RTWN_RIDX_MCS(0)) {
				r88ee_tx_set_ht40(sc, txd, ni);
				r88ee_tx_set_sgi(sc, txd, ni);
...
void
r88ee_fill_tx_desc_raw(struct rtwn_softc *sc, struct ieee80211_node *ni,
    struct mbuf *m, void *buf, const struct ieee80211_bpf_params *params)
{
	...
	/* XXX TODO: 11n checks, matching r88ee_fill_tx_desc() */
	...
	if (params->ibp_flags & IEEE80211_BPF_RTS)
		r88ee_tx_protection(sc, txd, IEEE80211_PROT_RTSCTS, ridx);
...
void
r88ee_fill_tx_desc_null(struct rtwn_softc *sc, void *buf, int is11b,
    int qos, int id)
{
#if 0
	struct r88ee_tx_desc *txd = (struct r88ee_tx_desc *)buf;
...
uint8_t
r88ee_tx_radiotap_flags(const void *buf)
{
#if 0
	const struct r88ee_tx_desc *txd = buf;
	uint8_t flags;
