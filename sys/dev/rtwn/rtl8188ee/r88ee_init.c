...
int
r88ee_check_condition(struct rtwn_softc *sc, const uint8_t cond[])
{
#if 0
...
void
r88ee_init_bb_common(struct rtwn_softc *sc)
{
#if 0
	struct r88ee_softc *rs = sc->sc_priv;
	int i, j;
...
int
r88ee_init_rf_chain(struct rtwn_softc *sc,
...
void
r88ee_init_rf(struct rtwn_softc *sc)
{
#if 0
	struct r88ee_softc *rs = sc->sc_priv;
	uint32_t reg, type;
...
void
r88ee_init_antsel(struct rtwn_softc *sc)
{
#if 0
	uint32_t reg;
...
void
r88ee_pa_bias_init(struct rtwn_softc *sc)
{
#if 0
	struct r88ee_softc *rs = sc->sc_priv;
	int i;
