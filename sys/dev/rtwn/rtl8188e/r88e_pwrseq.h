...
#ifndef RTL8188E_PWRSEQ_H
#define RTL8188E_PWRSEQ_H
...
bool pwrseqcmdparsing(struct rtwn_softc *sc, uint8_t cut_version, uint8_t faversion, uint8_t interface_type, struct wlan_pwr_cfg pwrcfgcmd[]);

#endif	/* RTL8188EE_PWR_H */
